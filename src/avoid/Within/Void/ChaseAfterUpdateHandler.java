...
public class ChaseAfterUpdateHandler implements IUpdateHandler
{
	private final LiveSprite chaser;
	private final ILive chased;
	private final float STEP_SPEED, DELTA_X, DELTA_Y;

	public ChaseAfterUpdateHandler(LiveSprite chaser, ILive chased, final float stepSpeed)
	{
		this.chaser = chaser;
		this.chased = chased;
